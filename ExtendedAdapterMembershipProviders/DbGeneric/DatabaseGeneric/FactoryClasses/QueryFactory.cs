...
namespace MyCorp.ExtendedAdapterMembershipProviders.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		/// <summary>Creates and returns a new EntityQuery for the WebpagesMembership entity</summary>
		public EntityQuery<WebpagesMembershipEntity> WebpagesMembership
		{
			get { return Create<WebpagesMembershipEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the WebpagesOauthMembership entity</summary>
		public EntityQuery<WebpagesOauthMembershipEntity> WebpagesOauthMembership
		{
			get { return Create<WebpagesOauthMembershipEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the WebpagesOauthToken entity</summary>
		public EntityQuery<WebpagesOauthTokenEntity> WebpagesOauthToken
		{
			get { return Create<WebpagesOauthTokenEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the WebpagesRole entity</summary>
		public EntityQuery<WebpagesRoleEntity> WebpagesRole
		{
			get { return Create<WebpagesRoleEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the WebpagesUsersInRole entity</summary>
		public EntityQuery<WebpagesUsersInRoleEntity> WebpagesUsersInRole
		{
			get { return Create<WebpagesUsersInRoleEntity>(); }
		}
